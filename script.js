...
const portfolioItems = [
  {
    id: "neiro",
    tag: "Нейрофото",
    name: "Нейрофото: семейные AI-портреты",
    desc: "Создаю уникальные нейропортреты с художественной обработкой и ретушью. Цена от 600 ₽. Подходит для соцсетей, подарков и семейных архивов."
  },
  {
    id: "site",
    tag: "AI-сайты",
    name: "Разработка лендингов и сайтов",
    desc: "Создаю продающие лендинги, корпоративные сайты и CRM-системы на React и Node.js. Адаптация под телефон, формы заявок, SEO-настройка. От 29 900 ₽."
  },
  {
    id: "bot",
    tag: "Макс боты",
    name: "Telegram-боты и автоматизация",
    desc: "Разрабатываю Telegram-ботов и AI-консультантов для автоматизации заявок, ответов на вопросы и сбора лидов. От 39 900 ₽."
  },
  {
    id: "market",
    tag: "Маркетплейсы",
    name: "Карточки товаров для WB и Ozon",
    desc: "Создаю дизайн карточек, инфографику и SEO-тексты для Wildberries и Ozon. Повышаю конверсию и узнаваемость бренда. От 3 500 ₽ за карточку."
  }
];
...
function ProfilePhoto() {
  ...
  return React.createElement(
    ...
    React.createElement("img", {
      src: "oksana.jpg",
      alt: "Оксана Баннова — разработчик и нейродизайнер",
      style: {
        width: "100%",
        height: "100%",
        objectFit: "cover"
  ...
  const getLocalResponse = (userText) => {
    ...
    if (text.includes('заказ') || text.includes('оформить') || text.includes('как заказать') || 
      ...
      return "📋 *Как сделать заказ:*\n\n" +
             "1️⃣ Напишите мне, что именно вас интересует.\n" +
             "2️⃣ Я уточню детали и посчитаю стоимость.\n" +
             "3️⃣ Мы согласовываем все нюансы (сроки, правки).\n" +
             "4️⃣ Я высылаю вам договор и счёт на оплату.\n" +
             "5️⃣ После оплаты я приступаю к работе.\n" +
             "6️⃣ Вы получаете готовый результат.\n\n" +
             "📌 Просто напишите, что хотите заказать — и я всё объясню!";
    }
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "p",
          { className: "subtitle" },
          "Помогаю бизнесу автоматизировать заявки, усиливать визуал и получать больше клиентов. Работаю по всей России — онлайн."
        ),
        React.createElement(
          "div",
          { className: "chips" },
        ...
        React.createElement(
          ...
          React.createElement("p", { className: "edu-item" }, "Прикладная математика и информатика, КемГУ — 2018"),
          React.createElement("p", { className: "edu-item" }, "JavaScript-разработчик, Нетология — 2025")
        ),
        React.createElement(
          "div",
          { className: "btn-row" },
        ...
        React.createElement(
          ...
          React.createElement(
            "a",
            {
              ...
              target: "_blank",
              className: "contact-btn",
              style: { borderColor: "rgba(33,212,253,0.6)" }
            },
            "💬 Написать в МАКС"
          )
        )
